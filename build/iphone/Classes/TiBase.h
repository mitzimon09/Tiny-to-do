...
// in simulator we redefine to format for TinyToDo Developer console
...
{\
	NSString * exceptionName = [@"org.tinytodo." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tinytodo";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITinyToDoNativeItemNone = -1, 
	UITinyToDoNativeItemSpinner = -2,
	UITinyToDoNativeItemProgressBar = -3,
	
	UITinyToDoNativeItemSlider = -4,
	UITinyToDoNativeItemSwitch = -5,
	UITinyToDoNativeItemMultiButton = -6,
	UITinyToDoNativeItemSegmented = -7,
	
	UITinyToDoNativeItemTextView = -8,
	UITinyToDoNativeItemTextField = -9,
	UITinyToDoNativeItemSearchBar = -10,
	
	UITinyToDoNativeItemPicker = -11,
	UITinyToDoNativeItemDatePicker = -12,
	
	UITinyToDoNativeItemInfoLight = -13,
	UITinyToDoNativeItemInfoDark = -14,
	
	UITinyToDoNativeItemDisclosure = -15,
	
	UITinyToDoNativeItemContactAdd = -16
};
