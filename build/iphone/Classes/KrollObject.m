...
//@interface TinyToDoObject : NSObject
//@end

@interface TinyToDoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TinyToDoObject class]])
		{
			for (NSString *key in [[(TinyToDoObject*)o modules] allKeys])
			{
